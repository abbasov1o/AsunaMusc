...
def start(client, message):
    Asuna = f'👋Salam {message.from_user.mention}\n\n𝗜Musiqi yükəmə botuyam🎸AsunaMusic𝐭[🎶](https://telegra.ph/file/aa3d30131515e46a83f3c.mp4)\n\nNümunə:`/musiqi Miro Sevgin batsın`'
    message.reply_text(
        text=Asuna, 
        quote=False,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton('Qrupa əlavə et', url='https://t.me/asunamusiccbot?startgroup=true')
                ]
            ]
        )
    )
...
def a(client, message):
    ...
    try:
        ...
        m.edit(
            "✖️Xahiş nümunədə olduğu kimi qeyd edin`/musiqi Miro Sevgin batsın`"
        )
        print(str(e))
        return
    ...
    try:
        ...
        rep = f'🎧Başlıq: [{title[:35]}]({link})\n⏳Müddət: `{duration}`\n🎬Mənbə: [Youtube](https://youtu.be/3pN0W4KzzNY)\n👁‍🗨 Baxış: `{views}`\n\n💌 𝐁𝐲 : @AsunaMusiccBot'
